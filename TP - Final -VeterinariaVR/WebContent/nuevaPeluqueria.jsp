							  ...
							  <h2>Nueva peluqueria</h2>
  								<table class="tablaMaqueta">
                                    ...
                                    <tr>
  		    							...
  		    							<td>
  		    							  	<select name="id_propietario" id="id_propietario" onchange="actualizar()"  class="entrada">
  		  							...
  		  							<tr><td>&nbsp;&nbsp;</td><td>&nbsp;&nbsp;</td></tr>
  		  							<tr>
  		  								<td><label for="id_animal">Mascota</label></td>
  		  								<td>
  		  									<select name="id_animal" id="id_animal" class="entrada">
 													...
 													if(listaAnimales.size()==0)
  		  											{	
  		  	   		 									out.print("<option value=''>No hay mascotas cargadas para el propietario</option>");
	  		  	   		 							}
  		  	   		 							%>   		  									
  		  									</select>
  		  								</td>
                                    ...
                                    <tr>
  		    							...
  		    							<td>
	    							    <input type="text" name="fecha" id="fecha" value="<%= fecha %>" class="entrada"/></td>
  		  							</tr>  	
  		    		  				<tr>
  		    							<td>Tratamiento</td>
  		    							<td><p>
  		    							<br></br>
  		    							  <label>
  		    							    <input type="radio" name="tratamiento" value="Corte y Baño" id="sexo_0"  <% if (tratamiento!=null && tratamiento.equals("Corte y Baño")){%><%="checked='checked'"%><%} %>>
  		    							    Corte y Baño</label>
  		    							  <br>
  		    							  <label>
  		    							    <input type="radio" name="tratamiento" value="Baño" id="sexo_1" <% if (tratamiento!=null && tratamiento.equals("Baño")){%><%="checked='checked'"%><%} %>>
  		    							    Baño</label>
  		    							  <br>
	    							    </p></td>
	      							</tr>
                                    ...
                                    <tr>
  		    							...
  		    							<td>
	    							    <textarea name="comentarios" id="comentarios" class="entrada" style="width: 300px; height: 80px;" maxlength="299" ><%= comentarios %></textarea></td>
  		  							</tr>  		  							
  		  							<tr><td>&nbsp;&nbsp;</td><td>&nbsp;&nbsp;</td></tr>
  		  							<tr>
  		  								<td>&nbsp;</td>  		  								
