...
<body>
	<div class="container">
		  ...
		  <!-- TemplateBeginEditable name="cuerpo"--------------------------------------------------------------------------------------------------------------------- -->
					...
					<!-- COMIENZO DIV ---------------------------------------------------------------- -->
						<div style="width: 49%; margin: 0 auto; text-align: center;"> 
							<form id="frmIntervencion" name="frmIntervencion" method="post" action="IntervencionServlet">
  								...
  								<label for="nombre">Nuevo nombre de la intervencion</label>
  		    					<input type="text" class="entrada" name="nombre" id="nombre" style="width:200px" value="<%= request.getSession().getAttribute("nombre") %>"/>
	      						<br></br>
	      						<input type="submit"  class="negro redondo boton"  name="button" id="button" value="Modificar" onclick="return validarIntervencion()" />
