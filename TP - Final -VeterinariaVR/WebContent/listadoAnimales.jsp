		...
		%>
						...
						<div style="float: left; clear:left; width: 95%;">					
							...
							<table class="listado">
								<thead class="listado" >                                
	                               	<tr>
                                       	<th class="listado" colspan="1" width="3%"></th>
                                       	<th class="listado" colspan="1" width="12%">Nombre</th>
                                       	<th class="listado" colspan="1" width="10%">Nacimiento</th>
                                       	<th class="listado" colspan="1" width="10%">Sexo</th>       
                                       	<th class="listado" colspan="1" width="20%">Propietario</th>                                       	
                                       	<th class="listado" colspan="1" width="15%">Animal</th>  
                                       	<th class="listado" colspan="1" width="15%">Raza</th>                                       	                                   	                                     	                               	
