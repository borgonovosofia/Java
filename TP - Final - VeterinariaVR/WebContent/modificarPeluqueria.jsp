...
<body>
	<div class="container">
		  ...
		  <% if(login==true && tipousuario.equals("V")){ %>
						...
						<!-- COMIENZO DIV ---------------------------------------------------------------- -->
						<div style="width: 100%; text-align: center; style="margin: 0 auto;"> 
  								...
  								<table class="tablaMaqueta" style="margin: 0 auto;">
  		    		  				...
  		    		  				<tr>
  		    							<td><label for="id_propietario">Propietario</label></td>
  		  								<td><input type="text" class="entrada" name="id_propietario" id="id_propietario" disabled="disabled" value="<%=nombreP+", "+apellidoP %>"/></td>  		    							  		  								

  		  							</tr>
  		  							<tr><td>&nbsp;&nbsp;</td><td>&nbsp;&nbsp;</td></tr>
  		  							<tr>
  		  								<td><label for="id_animal">Animal</label></td>
  		  								<td><input type="text" class="entrada" name="id_animal" id="id_animal" value="<%=nombre %>" disabled="disabled"/></td>  		    							  		  								
  		  							</tr>  			
  		  							<tr><td>&nbsp;&nbsp;</td><td>&nbsp;&nbsp;</td></tr>
  		  							<tr>
		  							...
		  							<tr>
  		    		 				...
  		    		 				<tr>
  		  								<td>&nbsp;</td>  		  								
  		  								<td><input type="submit"  class="negro redondo boton"  name="button" id="button" value="Modificar peluqueria" onclick="return validarNuevo();" />
