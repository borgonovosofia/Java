...
public class VacunaServlet extends HttpServlet {
	...
	//PARA AGREGAR UNA NUEVA VACUNA
		if(accion.equals("nuevo")){
				...
				Vacuna v = new Vacuna(Validaciones.validarCodigoDanino((String)request.getParameter("codigo")),Validaciones.validarCodigoDanino((String)request.getParameter("nombre")),Validaciones.validarCodigoDanino((String)request.getParameter("marca")),duracion);
				if(v!=null)
				{
					try{
						...
						if(rta==false)
						{
							...
							String codigo = Validaciones.validarCodigoDanino((String)request.getParameter("codigo"));
							String marca = Validaciones.validarCodigoDanino((String)request.getParameter("marca"));
							request.getSession().setAttribute("nombre", nombre);
							request.getSession().setAttribute("codigo", codigo);
							request.getSession().setAttribute("marca", marca);
