...
public class PropietarioServlet extends HttpServlet {
	...
	//PARA AGREGAR 
			if(accion.equals("nuevo")){
				...
				String apellido = Validaciones.validarCodigoDanino((String)request.getParameter("apellido"));
				String direccion = Validaciones.validarCodigoDanino((String)request.getParameter("direccion"));
				String email = Validaciones.validarCodigoDanino((String)request.getParameter("email"));
				String telefono_fijo = Validaciones.validarCodigoDanino((String)request.getParameter("telefono_fijo"));
				String celular = Validaciones.validarCodigoDanino((String)request.getParameter("celular"));
				String usuario = Validaciones.validarCodigoDanino((String)request.getParameter("usuario"));
				String clave = (String)request.getParameter("clave");
