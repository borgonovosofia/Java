...
public class TipoAnimalServlet extends HttpServlet 
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(accion.equals("nuevo")){
			request.getSession().setAttribute("busquedaTipo", "false");		
			TipoAnimal tipo = new TipoAnimal(Validaciones.validarCodigoDanino((String)request.getParameter("nombreTipo")));
			if(tipo!=null)
			{
				try{
		...
		else if(accion.equals("modificar"))
		{
			try {
				int idTipo = Integer.parseInt(request.getParameter("idTipo"));
				String nombre = Validaciones.validarCodigoDanino((String)request.getParameter("nombreTipo"));
		...
		{	
			try 
			{
				String valorBT = Validaciones.validarCodigoDanino(request.getParameter("bt"));
